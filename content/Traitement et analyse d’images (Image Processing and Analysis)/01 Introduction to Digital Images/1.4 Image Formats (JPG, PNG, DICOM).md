...
| Keyword                 | Description                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------- |
| [[Lossy Compression]]   | A compression method that permanently discards data to reduce file size (e.g., JPEG).                 |
| [[Lossless Compression]]| A compression method that reduces file size without any loss of data (e.g., PNG).                     |
| [[JPEG]]                | A common lossy format for photographs.                                                                  |
| [[PNG]]                 | A lossless format that supports transparency, ideal for web graphics.                                   |
| [[Alpha Channel]]       | An extra channel in an image that stores transparency information.                                      |
| [[RAW]]                 | A category of image formats that store minimally processed data from a camera sensor.                   |
| [[DICOM]]               | A standard format for medical imaging that includes both image data and rich metadata.                  |

---
tags: #introduction #image-format #compression #jpeg #png #dicom
