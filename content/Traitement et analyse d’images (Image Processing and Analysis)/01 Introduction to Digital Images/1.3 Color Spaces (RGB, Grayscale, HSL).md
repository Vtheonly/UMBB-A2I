...
| Keyword                 | Description                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------- |
| [[Color Space]]         | A mathematical model for representing colors as tuples of numbers (e.g., RGB, HSL).                     |
| [[RGB]]                 | An additive color model based on mixing Red, Green, and Blue light. Standard for digital displays.      |
| [[Grayscale]]           | A color space representing shades of gray, from black to white.                                         |
| [[HSL]]                 | A color model representing color as Hue, Saturation, and Lightness, which is often more intuitive.      |
| [[Luminance]]           | The perceived brightness or intensity of a pixel.                                                        |
| [[Additive Model]]      | A color model where colors are created by adding light (e.g., RGB).                                     |
| [[Subtractive Model]]   | A color model where colors are created by subtracting light (e.g., CMYK for printing).                  |

---
tags: #introduction #color-space #rgb #grayscale #hsl
