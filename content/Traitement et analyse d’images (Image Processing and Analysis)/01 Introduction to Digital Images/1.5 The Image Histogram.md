...
> [!seealso] For a more detailed explanation, see the [[In-Depth/Histogram|In-Depth note on Histograms]].
...
| Keyword                 | Description                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------- |
| [[In-Depth/Histogram|Histogram]]           | A graphical representation of the distribution of intensity values in an image.                         |
...
| [[Histogram Equalization]] | A contrast enhancement technique that redistributes pixel intensities to create a flatter histogram.    |
| [[Thresholding]]        | A segmentation method that creates a binary image by separating pixels based on an intensity threshold. |
| [[Bimodal Histogram]]   | A histogram with two distinct peaks, often indicating an image with a clear foreground and background.  |

---
tags: #introduction #histogram #contrast #brightness #segmentation
