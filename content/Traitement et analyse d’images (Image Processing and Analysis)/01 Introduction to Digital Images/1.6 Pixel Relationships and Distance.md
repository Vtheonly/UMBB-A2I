...
| Keyword                 | Description                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------- |
| [[Adjacency]]           | Defines which pixels are considered neighbors (e.g., 4-connectivity or 8-connectivity).                 |
| [[Connectivity]]        | The rule used to determine if pixels form a continuous path (4-way or 8-way).                           |
| [[Distance Metric]]     | A function that quantifies the spatial separation between two pixels.                                   |
| [[Euclidean Distance]]  | The standard straight-line distance between two points.                                                 |
| [[Manhattan Distance]]  | A distance metric based on a grid, allowing only horizontal and vertical movement.                      |
| [[Chebyshev Distance]]  | A distance metric based on the maximum difference along any coordinate axis.                            |

---
tags: #introduction #pixel #adjacency #connectivity #distance-metric
