...
| Keyword                  | Description                                                                                                                              |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| [[Image Processing]]     | The entire pipeline of acquiring, manipulating, and analyzing digital images to extract information.                                       |
| [[Computer Vision]]      | A field of AI that trains computers to interpret and understand the visual world.                                                         |
| [[Feature Extraction]]   | The process of transforming raw image data into a reduced set of meaningful features for analysis.                                         |
| [[Image Segmentation]]   | The process of partitioning a digital image into multiple segments (sets of pixels) to simplify or change its representation.              |

---
tags: #course-overview #objectives #fundamentals