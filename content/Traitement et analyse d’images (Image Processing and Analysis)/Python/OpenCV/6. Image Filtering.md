...
graph TD
    subgraph Input Image
        direction LR
        A1(25) -- x --> A2(30) -- x --> A3(40)
        B1(45) -- x --> B2(50) -- x --> B3(60)
        C1(70) -- x --> C2(75) -- x --> C3(80)
    end
    subgraph "Kernel (e.g., 3x3 Mean)"
        direction LR
        K1["1/9"] -- x --> K2["1/9"] -- x --> K3["1/9"]
        L1["1/9"] -- x --> L2["1/9"] -- x --> L3["1/9"]
        M1["1/9"] -- x --> M2["1/9"] -- x --> M3["1/9"]
    end
    Input Image -- Convolution --> Output_Pixel
    subgraph Output_Pixel
      OP((54))
    end
