...
These metrics are critical for comparing the performance of different filtering algorithms, as covered in [[Image Quality Metrics (MSE and PSNR)]].
...
| [[Image Quality Metrics MSE]] | Peak Signal-to-Noise Ratio; a common metric for quantifying the quality of a filtered or compressed image. |
| [[Image Quality Metrics MSE]] | Mean Squared Error; measures the average squared difference between two images.                            |
