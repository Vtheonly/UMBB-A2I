...
This note defines the concept of a digital image, its fundamental components, and its representation for computer processing.
...
2.  **Value:** A numerical value that represents its intensity (for grayscale images) or color (for color images).
