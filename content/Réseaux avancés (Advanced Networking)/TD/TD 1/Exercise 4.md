...
> [!Note] Machine M1 with IP `192.175.60.3` wants to send a global message (broadcast) on its network. What is the destination IP address, and which listed machines will respond?
