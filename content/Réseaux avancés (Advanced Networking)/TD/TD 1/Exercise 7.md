...
> [!Note] Given the starting network `172.60.0.0/20`, divide it into 4 subnets and list the network address, first/last usable IPs, and broadcast address for each.
