...
> **Problem:** For the list of IP addresses in the large table, determine if each is valid and usable, and if so, find its class, network/host portions, network address, and broadcast address.
