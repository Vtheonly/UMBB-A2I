...
> **Problem:** An IP datagram of 3820 bytes (20-byte header, 3800 bytes data) must cross a network with an MTU of 1500 bytes. Describe the resulting fragments.
...
3.  **Fragment Details:**
    -   A clear diagram shows F1 and F2 with 1480B of data and F3 with the remainder (`3800 - (1480*2) = 860B`). *Correction: the note says 840B for F3, which is 3800-2960. My initial math was slightly off. The note is correct!*
